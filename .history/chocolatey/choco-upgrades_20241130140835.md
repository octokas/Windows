...
2. Run the [`setup-choco-task.ps1`](SetupChocoUpgrader.ps1) script once as administrator _(i.e. `& ./setup-choco-task.ps1`)_
...
#### Regular Use:
1. Double-click the [`choco-auto-upgrade.ps1`](ChocoAutoUpgrader.ps1) script
