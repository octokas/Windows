...
- If you need additional help, you can run the scripts I've made for you in the [`with-annotations` directory](../chocolatey/drafts/with-annotations) in the Powershell Editor, VS Code, or any other IDE supporting powershell scripts
